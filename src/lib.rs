...
#[derive(Debug)]
pub struct CompassRiftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CompassRiftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CompassRift processing");
    
    let mut processor = CompassRiftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CompassRiftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CompassRiftProcessor::new(false);
